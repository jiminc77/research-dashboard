...
3. **워크플로 4종(pr-verify·phase-transition·gate-notify·evidence-verify) 커밋** — 관리 레포 `research-ops/workflows/`의 `gate-notify.yml`·`evidence-verify.yml`·`phase-transition.yml`을 CODE 레포 `.github/workflows/`에 복사·커밋.
